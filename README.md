...
As the second assignment was underway, I was very nervous working with people online that I never met in person. Tried to make contact with them through canvas but did not get any replies at first. Then everyone started replying and communicating, it was good to know that I wasn’t alone in how I felt. I then searched on how GitHub worked more and was able to understand it more than the first assignment so I would be able to catch up with the group. We all started suggesting on what was the best way to communicate. So we used social media to do so, made a group chat and started with who does what for the project. Everyone had work and were busy at times but, we all came together and collected what we could to get this assignment done. I believe that distance learning can be a challenge especially in these circumstances where communication is key to getting things done. I tried my best to be supportive and did all I could to work with the group, in the end I think that my efforts were not in vain. I was able to organize and make sure with the help of my peers that everything went as planned.
